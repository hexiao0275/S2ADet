...
def detect(opt):
    ...
    for (path, img, im0s, vid_cap), (path_, img2, im0s_, vid_cap_) in zip(dataset, dataset2):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            #
            # ---------------------------------------------------------------------------
            # annoPath = "/data/hexiao/hsi-detect/dataset/hsidetection/labels/test/"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/data/hexiao/hsi-detect/runsx3/train/exp65/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/data/hexiao/hsi-detect/dataset/hsidetection/rgb/images/test/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/data/hexiao/hsi-detect/dataset/hsidetection/ir/images/test/', help='source')  # file/folder, 0 for webcam
